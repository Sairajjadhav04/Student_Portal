...
public class StudentService {
    ...
    public Object dashboard(String username) {
        ...
        return java.util.Map.of(
                ...
                s.getCourse() == null
                        ? List.of()
                        : subjectRepository.findByCourseId(
                        s.getCourse().getId()),

                "attendance",
                attendanceRepository.findByStudentId(s.getId()),
                ...
                "marks",
                marksRepository.findByStudentId(s.getId()),

                "results",
                resultRepository.findByStudentId(s.getId())
        );
    }
    ...
    public List<Assignment> getAssignments(String username) {
        ...
        return assignmentRepository.findBySubjectCourseId(
