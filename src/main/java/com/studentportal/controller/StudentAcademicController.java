...
public class StudentAcademicController {
    ...
    public Object marks(Authentication auth) {
        ...
        return marksRepository.findByStudentId(
                studentService
                        .getByUsername(auth.getName())
                        .getId()
        );
    ...
    public Object assignments(Authentication auth) {
        ...
        var student =
                studentService.getByUsername(auth.getName());
    ...
    public Object submissions(Authentication auth) {

        var student =
                studentService.getByUsername(auth.getName());

        return submissionRepository.findByStudentId(
                student.getId()
        );
    }
